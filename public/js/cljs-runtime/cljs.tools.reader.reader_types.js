...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_14548 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_14548(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_14550 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_14550(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_14551 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_14551(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_14559 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_14559(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_14567 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_14567(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_14578 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_14578(reader);
}
});
...
var G__14644 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__14645 = s.append(c);
c = G__14644;
s = G__14645;
continue;
}
