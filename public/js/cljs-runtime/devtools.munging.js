...
var o12175 = temp__5751__auto__;
var temp__5751__auto____$1 = (o12175["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o12176 = temp__5751__auto____$1;
return (o12176["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__11697__auto__ = f;
return (o__11697__auto__["toString"]).call(o__11697__auto__);
} else {
return "";
}
}catch (e12181){var _ = e12181;
return "";
}});
...
try{var o__11697__auto___12569 = t;
(o__11697__auto___12569["cljs$lang$ctorPrWriter"]).call(o__11697__auto___12569,t,writer);
}catch (e12187){var __12570 = e12187;
}
...
var char_code = (function (){var o__11697__auto__ = (new String(char$));
return (o__11697__auto__["charCodeAt"]).call(o__11697__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__11697__auto__ = String;
return (o__11697__auto__["fromCharCode"]).call(o__11697__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12203 = num_code;
switch (G__12203) {
case (1):
return (185);
...
var o__11697__auto__ = String;
return (o__11697__auto__["fromCharCode"]).call(o__11697__auto__,superscript_code);
});
/**
...
}catch (e12224){var _e__11751__auto__ = e12224;
return false;
}})())){
...
var vec__12227 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12227,(0),null);
...
var len__4864__auto___12590 = arguments.length;
var i__4865__auto___12591 = (0);
while(true){
if((i__4865__auto___12591 < len__4864__auto___12590)){
args__4870__auto__.push((arguments[i__4865__auto___12591]));

var G__12592 = (i__4865__auto___12591 + (1));
i__4865__auto___12591 = G__12592;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12279){
var vec__12280 = p__12279;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12280,(0),null);
...
var G__12594 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__12595 = cljs.core.butlast(remaining_tokens);
name_tokens = G__12594;
remaining_tokens = G__12595;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12267){
var G__12269 = cljs.core.first(seq12267);
var seq12267__$1 = cljs.core.next(seq12267);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12269,seq12267__$1);
}));
...
var vec__12315 = cljs.core.split_with((function (p1__12310_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12310_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12315,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12315,(1),null);
...
var vec__12346 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12346,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12346,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__12602 = cljs.core.rest(remaining_tokens);
var G__12603 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__12602;
name_tokens = G__12603;
continue;
} else {
...
var vec__12374 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12374,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12374,(1),null);
var vec__12377 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12377,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12377,(1),null);
...
var vec__12395 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12395,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12395,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12395,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12395,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12395,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12395,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__12401 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12401,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12401,(1),null);
var vec__12406 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12406,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12406,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__12416 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__12416) : devtools.munging.parse_fn_info_deep.call(null,G__12416));
})()));
}
} else {
return fn_info;
...
var G__12619 = (arity + (1));
var G__12620 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12447){
var vec__12448 = p__12447;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12448,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12448,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12462_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__12462_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12463_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__12463_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12473){
var vec__12474 = p__12473;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12474,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12469){
...
var map__12503 = options;
var map__12503__$1 = cljs.core.__destructure_map(map__12503);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12503__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12503__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12503__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12503__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12504 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12504,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12504,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12504,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12504,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12504,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12504,(5),null);
...
var o__11697__auto__ = f;
return (o__11697__auto__["getBasis"]).call(o__11697__auto__);
});
/**
...
}catch (e12513){var _e__11751__auto__ = e12513;
...
var G__12652 = (obj[cljs.core.first(path)]);
var G__12653 = cljs.core.rest(path);
obj = G__12652;
path = G__12653;
continue;
} else {
...
var _STAR_ = (function (accum,p__12534){
var vec__12536 = p__12534;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12536,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12536,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12542){
var vec__12543 = p__12542;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12543,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12543,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12543,(2),null);
...
var post_process = (function (p__12555){
var vec__12556 = p__12555;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12556,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12556,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12548_SHARP_){
return (obj[cljs.core.first(p1__12548_SHARP_)]);
}),sorted_matches);
