...
var i_17514 = (self__.level + (1));
while(true){
if((i_17514 <= (new_level + (1)))){
(update[i_17514] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_17519 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_17519[i]));
} else {
x__$2.forward.push((((i < links_17519.length))?(links_17519[i]):null));
}

if((i < links_17519.length)){
(links_17519[i] = x__$2);
} else {
links_17519.push(x__$2);
}
...
var i_17530 = (0);
while(true){
if((i_17530 <= self__.level)){
var links_17531 = (update[i_17530]).forward;
if((x__$1 === (((i_17530 < links_17531.length))?(links_17531[i_17530]):null))){
(links_17531[i_17530] = (x__$1.forward[i_17530]));

var G__17534 = (i_17530 + (1));
i_17530 = G__17534;
continue;
} else {
var G__17536 = (i_17530 + (1));
i_17530 = G__17536;
continue;
}
} else {
...
var G__17542 = nx;
var G__17543 = (level__$1 - (1));
x = G__17542;
level__$1 = G__17543;
continue;
} else {
var G__17544 = x;
var G__17545 = (level__$1 - (1));
x = G__17544;
level__$1 = G__17545;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__17548 = nx;
var G__17549 = (level__$1 - (1));
x = G__17548;
level__$1 = G__17549;
continue;
} else {
var G__17550 = x;
var G__17551 = (level__$1 - (1));
x = G__17550;
level__$1 = G__17551;
continue;
}
