...
var len__4864__auto___12664 = arguments.length;
var i__4865__auto___12665 = (0);
while(true){
if((i__4865__auto___12665 < len__4864__auto___12664)){
args__4870__auto__.push((arguments[i__4865__auto___12665]));

var G__12668 = (i__4865__auto___12665 + (1));
i__4865__auto___12665 = G__12668;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq12626){
var G__12627 = cljs.core.first(seq12626);
var seq12626__$1 = cljs.core.next(seq12626);
var G__12628 = cljs.core.first(seq12626__$1);
var seq12626__$2 = cljs.core.next(seq12626__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12627,G__12628,seq12626__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__12638_SHARP_){
return (!((cljs.core.meta(p1__12638_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12647__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e12648){var _e__11751__auto__ = e12648;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e12650){var _e__11751__auto__ = e12650;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__12654 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__12655 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__12655);

try{var map__12656 = opts;
var map__12656__$1 = cljs.core.__destructure_map(map__12656);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12656__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__12654);
}});
...
var temp__5751__auto___12674 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___12674)){
var managed_print_level_12675 = temp__5751__auto___12674;
var _STAR_print_level_STAR__orig_val__12659_12676 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__12660_12677 = managed_print_level_12675;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__12660_12677);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__12658_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__12658_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__12659_12676);
}} else {
job_fn();
}
